...
public class SeckillTask {
    ...
    public void refreshSeckillGoods(){
        System.out.println("执行秒杀商品增量更新任务调度：" + new Date());
        //查询缓存中的秒杀商品ID集合
        ...
        criteria.andStartTimeLessThanOrEqualTo(new Date());//开始是日小于等于当前日期
        criteria.andEndTimeGreaterThanOrEqualTo(new Date());//结束日期大于等于当前日期
    ...
    public void removeSeckilGoods(){
        //查询出缓存这那个的数据，扫描每条记录，判断时间，如果当前时间超过了截止时间，移除此记录
        ...
        System.out.println("执行清除秒杀商品任务。。。end");
    }
}
